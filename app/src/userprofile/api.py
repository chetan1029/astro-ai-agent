...
from app.src.userprofile.exceptions import DataStoreError, UserProfileNotFoundError, UserProfileAlreadyExistsError
...
@router.get("/{phone_number}", status_code=status.HTTP_200_OK, response_model=UserProfileResponse)
